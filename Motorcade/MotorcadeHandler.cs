        ...
        GameFiber.StartNew(delegate
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    followingDriver.Tasks.DriveToPosition(leader.GetOffsetPosition(Vector3.RelativeBack * distance), speed, VehicleDrivingFlags.IgnorePathFinding);
                    GameFiber.Sleep(60);
                    ...
                    speed = leader.Speed;
                    if (Vector3.Distance(leader.Position, following.Position) > 500f)
                    {
